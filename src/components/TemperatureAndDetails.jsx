...
function TemperatureAndDetails({weather : {details, icon, temp, temp_max, temp_min, sunrise, sunset, humidity, speed, feels_like, timezone}}) {
    return (
        <div>
            <div className={`flex items-center justify-center py-6 text-xl font-light text-gray-300`}>
                <p>{details}</p>
            </div>
